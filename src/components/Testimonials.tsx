    ...
    <section id="why-choose-us" className="px-4 md:px-12 py-16 bg-white font-sans">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pb-24">
          ...
          {/* Row 1, Col 1: Testimonial card with image + short caption */}
          <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm overflow-hidden flex flex-col justify-between reveal-up delay-100">
            ...
            <div className="p-5 flex flex-col flex-1 justify-between">
              <p className="text-sm text-gray-600 leading-relaxed font-medium">
                "Build quality is insane. Cable management was perfect — guided me the whole way."
              </p>
          ...
          {/* Row 1, Col 2: Tall video card */}
          <div className="relative rounded-[24px] overflow-hidden bg-[#0a1b2d] min-h-[640px] flex items-center justify-center group cursor-pointer shadow-sm reveal-up delay-200">
            <img
          ...
          {/* Row 1, Col 3: Testimonial card with image + short caption */}
          <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm overflow-hidden flex flex-col justify-between reveal-up delay-300">
            <div className="h-[200px] overflow-hidden">
              <img
            ...
            <div className="p-5 flex flex-col flex-1 justify-between">
              <p className="text-sm text-gray-600 leading-relaxed font-medium">
                "Genuine products, fast delivery, and support that actually picks up."
              </p>
              <div className="flex items-center space-x-3 border-t border-gray-100 pt-4 mt-3">
                <img
          ...
          {/* Row 2, Col 1: Tall video card */}
          <div className="relative rounded-[24px] overflow-hidden bg-[#0a1b2d] min-h-[640px] flex items-center justify-center group cursor-pointer shadow-sm reveal-up delay-400">
            <img
          ...
          {/* Row 2, Col 2: Stars + text only */}
          <div className="bg-white rounded-[24px] border border-gray-100 shadow-sm p-6 flex flex-col justify-between reveal-up delay-500">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600 leading-relaxed font-medium text-left">
                "Upgrade recommendations boosted my FPS without blowing the budget. Highly recommended."
              </p>
            </div>
            <div className="flex items-center space-x-3 border-t border-gray-100 pt-4 mt-3">
              <img
          ...
          {/* Row 2, Col 3: Tall video card */}
          <div className="relative rounded-[24px] overflow-hidden bg-[#0a1b2d] min-h-[640px] flex items-center justify-center group cursor-pointer shadow-sm">
            <img
        ...
        {/* Bottom white gradient fade mask — taller for stronger effect */}
        <div className="absolute bottom-0 left-0 right-0 h-56 bg-gradient-to-t from-white via-white/80 to-transparent pointer-events-none z-10" />
      </div>
